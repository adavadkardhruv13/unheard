...
const LandingPage = () => {
  return (
    <div className="relative bg-lavenderblush-200 w-full h-[4934px] overflow-hidden text-center text-51xl text-red-100 font-montserrat">
      ...
      <div
        className="absolute top-[3849.59px] left-[61px] w-[1043px] h-[494px] flex flex-col pt-[9px] px-0 pb-0 box-border items-start justify-start gap-[51px]"
      ...
      >
        <img
          className="absolute top-[67px] left-[837px] w-[565px] h-[675px] object-cover"
          alt=""
          src="/image1@2x.png"
        />
        <NavigationContainer />
