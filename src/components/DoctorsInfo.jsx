...
const DoctorsInfo = () => {
    return (
      <div className="relative bg-lavenderblush-200 w-full h-[3051px] overflow-hidden text-left text-5xl text-red-100 font-montserrat">
        <iframe className="[border:none] absolute top-[1190px] left-[79px] w-[1089px] h-[280px]" />
        <img
          className="absolute top-[150px] left-[444px] w-[365px] h-[373.18px]"
          alt=""
          src="/doc-img.svg"
        />
        <div className="absolute top-[819px] left-[79px] w-[1089px] h-[280px] text-black">
          <div className="absolute top-[0px] left-[0px] rounded-16xl bg-pink-200 w-[1089px] h-[280px]" />
          <div className="absolute top-[126px] left-[64px] font-medium flex items-center w-[923px]">{`Lorem ipsum dolor sit amet. Est voluptatem culpa ut iste voluptas aut dolore repudiandae. Non similique totam  Lorem ipsum dolor sit amet. Est voluptatem culpa ut iste voluptas aut dolore repudiandae. Non similique totam `}</div>
          <div className="absolute top-[23px] left-[64px] text-31xl font-medium flex items-center w-[257px] h-[75px]">
            Overview
          </div>
          <img
        ...
        <div className="absolute top-[614px] left-[366px] text-21xl flex items-center w-[515px] h-[75px]">{`Gynaecologist MBBS, MD `}</div>
        <b className="absolute top-[539px] left-[400px] text-31xl flex items-center w-[453px] h-[75px]">{`Dr. Ashok Kumar `}</b>
        <img
          className="absolute top-[1559px] left-[128px] w-[1027px] h-[770px] object-cover"
          alt=""
          src="/image-4@2x.png"
        />
        <div className="absolute top-[2523px] left-[0px] w-[1280px] h-[528px] text-center text-xl text-gray-200">
          <img
        ...
        <div className="absolute top-[0px] left-[0px] w-[1280px] h-[87px] text-center text-33xl text-gray-200">
