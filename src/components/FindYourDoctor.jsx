...
const FindYourDoctor = () => {
    return (
      <div className="relative bg-lavenderblush-200 w-full h-[1808px] overflow-hidden text-center text-xl text-gray-200 font-montserrat">
        <div className="absolute top-[1280px] left-[0px] w-[1280px] h-[528px]">
          <img
        ...
        <div className="absolute top-[calc(50%_-_484px)] left-[calc(50%_-_536px)] text-45xl font-semibold text-left text-red-100">
          <span>{`TOP `}</span>
          <span className="text-black">Doctors-</span>
        </div>
        <div className="absolute top-[644px] left-[119px] w-[1043px] h-[349px]">
        ...
        <img
          className="absolute top-[1418px] left-[0px] w-[1280px] h-[390px] object-cover"
          alt=""
          src="/doctor-bg@2x.png"
        />
        <div className="absolute top-[0px] left-[0px] w-[1280px] h-[357px] text-mid text-white">
