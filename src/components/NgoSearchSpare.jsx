...
const NgoSearchSpare = () => {
  return (
    <div className="relative bg-lavenderblush-200 w-full h-[1996px] overflow-hidden text-center text-17xl text-gray-200 font-montserrat">
      <div className="absolute top-[387px] left-[125px] w-[1030px] h-[1036px] text-left">
        <div className="absolute top-[0px] left-[0px] w-[1030px] h-[235px]">
          <div className="absolute top-[0px] left-[0px] w-[1030px] h-[235px]">
            <div className="absolute top-[-0.5px] left-[-0.5px] rounded-6xl bg-lightpink [backdrop-filter:blur(4px)] box-border w-[1031px] h-[236px] border-[1px] border-solid border-red-100" />
            <div className="absolute top-[28px] left-[71px] w-[888px] h-[179.07px]">
              <Button
                className="absolute top-[141px] left-[0px]"
        ...
        <div className="absolute top-[534px] left-[0px] w-[1030px] h-[235px]">
          <div className="absolute top-[0px] left-[0px] w-[1030px] h-[235px]">
            <div className="absolute top-[-0.5px] left-[-0.5px] rounded-6xl bg-lightpink [backdrop-filter:blur(4px)] box-border w-[1031px] h-[236px] border-[1px] border-solid border-red-100" />
            <div className="absolute top-[28px] left-[71px] w-[888px] h-[179.07px]">
              <Button
        ...
        <div className="absolute top-[267px] left-[0px] w-[1030px] h-[235px]">
          <div className="absolute top-[0px] left-[0px] w-[1030px] h-[235px]">
            <div className="absolute top-[-0.5px] left-[-0.5px] rounded-6xl bg-lightpink [backdrop-filter:blur(4px)] box-border w-[1031px] h-[236px] border-[1px] border-solid border-red-100" />
            <div className="absolute top-[28px] left-[71px] w-[888px] h-[179.07px]">
              <Button
        ...
        <div className="absolute top-[801px] left-[0px] w-[1030px] h-[235px]">
          <div className="absolute top-[0px] left-[0px] w-[1030px] h-[235px]">
            <div className="absolute top-[-0.5px] left-[-0.5px] rounded-6xl bg-lightpink [backdrop-filter:blur(4px)] box-border w-[1031px] h-[236px] border-[1px] border-solid border-red-100" />
            <div className="absolute top-[28px] left-[71px] w-[888px] h-[179.07px]">
              <Button
